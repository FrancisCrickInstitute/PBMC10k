...
for (i in 1:length(clusterVec)){
    ...
    link <- paste0('<a href="https://',urlString,'/',Obio@parameterList$project_id,'/scatterplot?x_axis=add_counts_Avg_log10_Expr_all&y_axis=',suffix,'Avg_log10_Expr_',clusterVec[i], '&cat_id=', LRcatID,'" target="_blank">here</a>')
    
    linkDGE <- paste0('<a href="https://',urlString,'/',Obio@parameterList$project_id,'/scatterplot?x_axis=add_counts_Avg_log10_Expr_all&y_axis=',suffix,'Avg_log10_Expr_',clusterVec[i], '&cat_id=', DGEcatID,'" target="_blank">here</a>')
...
#for (i in 1:length(tabClusters)){
    ...
    orderVec <- c('gene','ClusterName','Cluster','DGE_avg_diff','DGE_power','LinearReg_Residuals','uniqueMarker','Perc_Cells_Expr')

---
title: "QC for Project VPL362A"
subtitle: "Zebrafish Neuron Glia"
author: 
...
# sbatch --time=12:00:00 --wrap "module purge;source /camp/stp/babs/working/software/modulepath_new_software_tree_2018-08-13;module load pandoc/2.2.3.2-foss-2016b;ml R/3.6.0-foss-2016b-BABS;Rscript runA.r" --job-name="rA" -p hmem --mem=100G -o rA.slurm >> commands.txt
...
singleCellClusterParameter <- 0.7
NtopGenes <- 2000
singleCellSeuratMtCutoff <- c(5)
...
sampleDetailList <- list(
    "S" = list(
        "type" = "TenX",
        "path" = "/camp/stp/babs/working/boeings/Projects/pachnisv/tiffany.heanue/362_10X_single_cell_RNA_seq_enteric_neurons_nuclei_rerun_SC18139/FASTQ_files/HEA614A1/outs/filtered_feature_bc_matrix",
...
projectDetailList <- list(
    "folder" = "pachnisv/tiffany.heanue/362A_10X_single_cell_RNA_seq_enteric_neurons_nuclei_rerun_SC18139/",
    "sra.id.vector" = "",
    "gse.id.vector" = "",
    "asf.id" = "SC18139",
...
documentationParams <- list(
    ...
    "subtitle" = "Pachnis Lab - Tiffany Heanue and Tiffany Heanue and Elina Fourli",
    "abstract" = "TBA"
)

...
singleCellClusterParameter <- 0.25
NtopGenes <- 2000
singleCellSeuratMtCutoff <-  c(15,15,20)
singleCellSeuratNpcs4PCA <- 30
SeuratNrnaMaxFeatures <- 10000
SeuratNrnaMinFeatures <- 1500
## Done                                                                      ##
###############################################################################
...
sampleDetailList <- list(
    "DIV0" = list(
        "type" = "TenX",
        "gene.column" = 2, # default 2
        "path" = "/camp/stp/babs/working/boeings/Projects/pachnisv/song.chng/330_10xscRNAseq_DIV4_DIV11_DIV20_SC19069/FASTQ_files/CHN106A13/outs/filtered_feature_bc_matrix",
        "singleCellClusterParameter" = singleCellClusterParameter,
        "singleCellSeuratMtCutoff" = 15,
    ...
    "DIV4" = list(
        "type" = "TenX",
        "gene.column" = 2, # default 2
        "path" = "/camp/stp/babs/working/boeings/Projects/pachnisv/song.chng/330_10xscRNAseq_DIV4_DIV11_DIV20_SC19069/FASTQ_files/CHN106A1/outs/filtered_feature_bc_matrix",
        "singleCellClusterParameter" = singleCellClusterParameter,
        "singleCellSeuratMtCutoff" = 15,
        "singleCellSeuratNpcs4PCA" = singleCellSeuratNpcs4PCA,
        "SeuratNrnaMaxFeatures" = SeuratNrnaMaxFeatures,
    ...
    "DIV10" = list(
        "type" = "TenX",
        "gene.column" = 2, # default 2
        "path" = "/camp/stp/babs/working/boeings/Projects/pachnisv/song.chng/330_10xscRNAseq_DIV4_DIV11_DIV20_SC19069/FASTQ_files/CHN106A2/outs/filtered_feature_bc_matrix",
        "singleCellClusterParameter" = singleCellClusterParameter,
        "singleCellSeuratMtCutoff" = 15,
        "singleCellSeuratNpcs4PCA" = singleCellSeuratNpcs4PCA,
        "SeuratNrnaMaxFeatures" = SeuratNrnaMaxFeatures,
    ...
    "DIV20" = list(
        "type" = "TenX",
        "gene.column" = 2, # default 2
        "path" = "/camp/stp/babs/working/boeings/Projects/pachnisv/song.chng/330_10xscRNAseq_DIV4_DIV11_DIV20_SC19069/FASTQ_files/CHN106A5/outs/filtered_feature_bc_matrix",
        "singleCellClusterParameter" = singleCellClusterParameter,
...
projectDetailList <- list(
    "folder" = "pachnisv/song.chng/412_10xscRNAseq_DIV0_DIV4_DIV11_DIV20_SC19069/",

...
baseFN <- "agl315A.DGE.table.xlsx"
outPutFN <- paste0(
  gsub("working/boeings/","", hpc.mount),
  "www/boeings/bioLOGIC_external/data/agl315A/html/report_tables/agl315A.DGE.table.xlsx"
)
...
database.table <- import.db.table.from.db(
    dbtable= "agl315A_sc_rna_seq_table",   
    dbname= "csl_data",   
    user= "boeingS",     
    password= db.pwd, 
    host= Obio@parameterList$host

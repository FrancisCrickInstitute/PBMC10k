...
baseFN <- "asl319.DGE.table.New.xlsx"
outPutFN <- paste0(
  gsub("working/boeings/","", hpc.mount),
  "www/boeings/bioLOGIC_external/data/asl319/html/report_table/asl319.DGE.table.1.percent.min.xlsx"
)
...
database.table <- import.db.table.from.db(
    dbtable= "asl319_sc_rna_seq_table",   
    dbname= "asl_data",   
    user= "boeingS",     
    password= db.pwd, 
    host= Obio@parameterList$host
...
Obio@parameterList$primDataDB <- "asl_data"
...
cmd.vec <- upload.datatable.to.database(
    ...
    db.col.parameter.list = list(
        ...
        "DECIMAL(6,3) NULL DEFAULT NULL" = c("add_counts_",  "lg2BaseMean","lg2baseMean","contrast_P_PCA_estimatePCA","^CoVar$","NES", "logFC", "lg2_avg","norm_counts", "intensity", "^int", "iBAQ","^localization_prob$", "stat", "lg10p","contrast_x_"),

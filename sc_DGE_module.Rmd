...
DGEinputList <- list(
  ...
  "comp_2" = list(
      "name"    = "DGE_Prad_Rest_vs_Ctrl_Rest",
      "DGEselCol" = "cluster_sample",
      "DGEsampleList" = list(
          "Prad_Rest"   = c("C0_Prad","C1_Prad","C2_Prad","C3_Prad","C4_Prad","C5_Prad","C6_Prad","C7_Prad","C9_Prad"),
          "Ctrl_Rest" = c("C0_Ctrl","C1_Ctrl","C2_Ctrl","C3_Ctrl","C4_Ctrl","C5_Ctrl","C6_Ctrl","C7_Ctrl","C9_Ctrl")
      )
  ),
  "comp_3" = list(
      "name"    = "DGE_Prad_C5_vs_Ctrl_C5",
      "DGEselCol" = "cluster_sample",
      "DGEsampleList" = list(
          "Prad_C5"   = c("C5_Prad"),
          "Ctrl_C5" = c("C5_Ctrl")

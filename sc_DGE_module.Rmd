...
DGEinputList <- list(
  ...
  "comp_2" = list(
      ...
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronsChAT" = c(0,3,6,7),
          "NeuronsOther"   = c(1,4,5,10)
      )
  ),
  "comp_3" = list(

...
OsC@meta.data[["Region"]] <- OsC@meta.data$sampleID
OsC@meta.data$Region <- gsub("4T1", "", OsC@meta.data$Region )
OsC@meta.data$Region <- gsub("CT26", "", OsC@meta.data$Region )
...
upload.datatable.to.database(
    ...
    db.col.parameter.list = list(
        "VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci" = c("cellType","cellIdent","sample_","cellID","orig_ident","old_ident","clustIdent", "hmIdent","sampleID", "clusterName", "ClusterName", "ClusterTest",  "clusterColor", "sampleName", "sampleColor", "CellFromTumor", "Patient", "Region",  "Article_Cell_Type", "Gender","Glia_vs_Neuron", "NitChol_vs_Serotonergic", "Nitrergic_vs_Cholinergic", "Sample_Group", "CC_Difference", "meta_", "cluster_sample", "DGE_GliaT_vs_NeuronT"),
...
cmd.vec <- upload.datatable.to.database(
    ...
    db.col.parameter.list = list(
        ...
        "DECIMAL(6,3) NULL DEFAULT NULL" = c("avg_diff_Cluster","add_counts_",  "lg2BaseMean","lg2baseMean","contrast_P_PCA_estimatePCA","^CoVar$","NES", "logFC", "lg2_avg","norm_counts", "intensity", "^int", "iBAQ","^localization_prob$", "stat", "lg10p","contrast_x_", "_AvgExpr$", "_var_std$", "add_MA_"),

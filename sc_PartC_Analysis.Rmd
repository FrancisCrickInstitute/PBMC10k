...
dfdbTable[["sample_id"]] <- paste0(dfdbTable$sample_id, "_C", dfdbTable[,"seurat_clusters"], "_1")

dfdbTable[["sample_id"]] <- dfdbTable$uniquecellID

dfdbTable[["sample_group"]] <- paste0("Cluster_", dfdbTable[,"seurat_clusters"])
## Assign colors ##
library(scales)
...
upload.datatable.to.database(
    ...
    db.col.parameter.list = list(
        "VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci" = c("cellType","cellIdent","sample_","cellID","orig_ident","old_ident","clustIdent", "hmIdent","sampleID", "CellFromTumor", "Patient", "Region",  "Article_Cell_Type", "Gender","Glia_vs_Neuron", "NitChol_vs_Serotonergic", "Nitrergic_vs_Cholinergic", "Sample_Group"),

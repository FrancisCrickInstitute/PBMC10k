...
This analyis gives an indication of which cells MIGHT be doublets. Chris McGinnis [DoubletFinder package]("https://github.com/chris-mcginnis-ucsf/DoubletFinder") is used to identify potential doublets. 
...
if (length(grep("sampleID", names(OsC@meta.data))) > 0){
    ...
    ## THis study only
    cluster.averages <- AverageExpression(OsC, return.seurat = TRUE, add.ident = "Patient")
    ## end this study only

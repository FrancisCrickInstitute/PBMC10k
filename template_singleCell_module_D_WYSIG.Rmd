...
#Obio@dbDetailList$host <- "10.27.241.82"
#Obio@dbDetailList$db.user <- "boeingS"

## Internal database credentials ##
#Obio@dbDetailList$host <- "10.27.241.234"
#Obio@dbDetailList$db.user <- "boeingS"

## External database credentials ##
# Obio@dbDetailList$host <- "www.biologic-db.org"
# Obio@dbDetailList$db.user <- "boeings"
# db.pwd <- "5+3f4nB04042018"

## Upload metadata table > p315_PCA
# Obio@dbDetailList$host <- "10.152.22.193"
# Obio@dbDetailList$db.user <- "boeingS"
# db.pwd <- "5+3f4nB04042018"
...
###############################################################################
## Add additonal split                                                       ##
# "NormCon"  "HypCon"   "NormPrad" "HypPrad"  "NormAZ"   "HypAZ"

OsC@meta.data[["Norm_Hyp"]] <- ""
OsC@meta.data[grep("Norm", OsC@meta.data$sampleID), "Norm_Hyp"] <- "Norm"
OsC@meta.data[grep("Hyp", OsC@meta.data$sampleID), "Norm_Hyp"] <- "Hyp"

OsC@meta.data[["Con_Prad_AZ"]] <- ""
OsC@meta.data[grep("Con", OsC@meta.data$sampleID), "Con_Prad_AZ"] <- "Con"
OsC@meta.data[grep("Prad", OsC@meta.data$sampleID), "Con_Prad_AZ"] <- "Prad"
OsC@meta.data[grep("AZ", OsC@meta.data$sampleID), "Con_Prad_AZ"] <- "AZ"


## Done adding additonal split                                               ##
###############################################################################

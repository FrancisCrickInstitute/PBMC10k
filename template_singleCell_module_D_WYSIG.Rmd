...
query7a <- paste0(
    "GRANT SELECT on ", Obio@parameterList$primDataDB,".",Obio@parameterList$PCAdbTableName, " TO ",sUser,"@'10.%';"
)
...
query8a <- paste0(
    "GRANT SELECT on ", Obio@parameterList$primDataDB,".",expDbTable, " TO ",sUser,"@'10.%';"
)
...
geneTb <- paste0(Obio@parameterList$project_id, "_geneID_tb")
query9a <- paste0(
    "GRANT SELECT on ", Obio@parameterList$primDataDB,".",geneTb, " TO ",sUser,"@'10.%';"
)
...
selVec <- c(
    ...
    names(dfAddCounts)[grep("contrast_2_padj", names(dfAddCounts))],
     names(dfAddCounts)[grep("contrast_5_logFC", names(dfAddCounts))],
    names(dfAddCounts)[grep("contrast_5_lg10p", names(dfAddCounts))],
    names(dfAddCounts)[grep("contrast_5_padj", names(dfAddCounts))]
)
# # 
...
names(dfAddCounts) <- gsub("contrast_2_logFC_", "contrast_A_logFC_bulkRNASeq_agl298_", names(dfAddCounts) )
names(dfAddCounts) <- gsub("contrast_2_padj_", "contrast_A_padj_bulkRNASeq_agl298_", names(dfAddCounts) )
names(dfAddCounts) <- gsub("contrast_2_lg10p_", "contrast_A_lg10p_bulkRNASeq_agl298_", names(dfAddCounts) )

names(dfAddCounts) <- gsub("contrast_5_logFC_", "contrast_A_logFC_bulkRNASeq_agl298_", names(dfAddCounts) )
names(dfAddCounts) <- gsub("contrast_5_padj_", "contrast_A_padj_bulkRNASeq_agl298_", names(dfAddCounts) )
names(dfAddCounts) <- gsub("contrast_5_lg10p_", "contrast_A_lg10p_bulkRNASeq_agl298_", names(dfAddCounts) )

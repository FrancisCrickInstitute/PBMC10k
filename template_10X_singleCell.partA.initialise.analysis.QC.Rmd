---
title: "QC for Project RLL358A"
subtitle: "Drug-treatment assessment"
author: 
...
sampleDetailList <- list(
    "PD7_1" = list(
        "type" = "TenX",
        "path" = "/camp/stp/babs/working/boeings/Projects/lovellbadger/emily.frost/358_RLL_EF_single_cell_p27kip1_in_ovarian_granulosa_cells_SC19235/FASTQ_files/FRO575A1/outs/filtered_feature_bc_matrix",
    ...
    "PD4_2" = list(
        "type" = "TenX",
        "path" = "/camp/stp/babs/working/boeings/Projects/lovellbadger/emily.frost/358_RLL_EF_single_cell_p27kip1_in_ovarian_granulosa_cells_SC19235/FASTQ_files/FRO575A2/outs/filtered_feature_bc_matrix",
        "singleCellClusterParameter" = singleCellClusterParameter,
        "singleCellSeuratMtCutoff" = singleCellSeuratMtCutoff,
        "singleCellSeuratNpcs4PCA" = singleCellSeuratNpcs4PCA,
        "SeuratNrnaMaxFeatures" = SeuratNrnaMaxFeatures,
    ...
    "E18_5_1" = list(
        "type" = "TenX",
        "path" = "/camp/stp/babs/working/boeings/Projects/lovellbadger/emily.frost/358_RLL_EF_single_cell_p27kip1_in_ovarian_granulosa_cells_SC19235/FASTQ_files/FRO575A3/outs/filtered_feature_bc_matrix",
        "singleCellClusterParameter" = singleCellClusterParameter,
        "singleCellSeuratMtCutoff" = singleCellSeuratMtCutoff,
        "singleCellSeuratNpcs4PCA" = singleCellSeuratNpcs4PCA,
        "SeuratNrnaMaxFeatures" = SeuratNrnaMaxFeatures,
...
projectDetailList <- list(
    "folder" = "lovellbadger/emily.frost/358A_RLL_EF_single_cell_p27kip1_in_ovarian_granulosa_cells_SC19235/",
    "sra.id.vector" = "",
    "gse.id.vector" = "",
    "asf.id" = "SC19135",
...
Obio = new(
    ...
    parameterList = list(
        "lab.categories.table" = "rl_lab_categories", # default NULL
